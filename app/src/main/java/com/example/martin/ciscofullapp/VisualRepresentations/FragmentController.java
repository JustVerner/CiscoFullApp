...
import com.example.martin.ciscofullapp.VisualRepresentations.FragmentPie;
...
public class FragmentController extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentOne(), "Insert");
        adapter.addFragment(new FragmentTest(), "RAW");
        adapter.addFragment(new FragmentGraph(), "Line graph");
        adapter.addFragment(new FragmentPie(), "Pie graph");
